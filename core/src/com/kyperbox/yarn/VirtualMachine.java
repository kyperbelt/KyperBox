...
public class VirtualMachine {
	...
	protected void runInstruction(Instruction instruction) {
		...
		case PushVariable:
			...
			Value top_value = state.peekValue();
		...
		case ShowOptions:
			...
			//if we have a single option, and it has no label, select it and continue execution
