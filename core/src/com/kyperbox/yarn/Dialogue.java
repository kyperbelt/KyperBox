...
public class Dialogue {
	...
	public void loadString(String text,String file_name,boolean show_tokens,boolean show_tree,String only_consider) {
	...
	/**
	 * Start a thread that spits out results
	 * waits for results to be consumed
	 */
	 ...
	 */
	public void update() {
		if(vm.getExecutionState() != ExecutionState.WaitingOnOptionSelection && vm.getExecutionState() != ExecutionState.Stopped)
			vm.runNext();
	}
	
	public RunnerResult getNextResult() {
