...
public class AnimationController extends GameObjectController {
	...
	/**
	 * Play speed gets applied to the update delta value to increase or decrease the
	...
	public void set(String name, PlayMode mode) {
		if (animations.containsKey(name)) {
			...
			throw new IllegalArgumentException(StringUtils.format(
					"AnimationController from object[%s] could not find the animation[%s].", daddy.getName(), name));
		}
	}
	...
	/**
	 * set the animation currently played by this animation controller. Animations
	 * are retrieved from the animation store in KyperBoxGame.java
	 * 
	 * @param animation
	 * @param playmode
	 *            - the animation playmode
	 */
	...
	/**
	 * check to see if The animation is finished by checking the animation total
	 * duration against elapsed time
	 * 
